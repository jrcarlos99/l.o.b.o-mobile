  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <NavigationButton title="Privacidade" screenName="settings/privacy" />
        <NavigationButton
        ...
        <TouchableOpacity style={styles.menuItem}>
          ...
          <View style={styles.themeContainer}>
            ...
            >
              <View
                style={[styles.radio, tema === "claro" && styles.radioSelected]}
              />
              <Text>Claro</Text>
            </TouchableOpacity>
            <TouchableOpacity
        ...
        {Object.entries(notifications).map(([key, value]) => (
          ...
          >
            ...
            <Text>
              ...
              {key === "faltaEquipamento" && "Falta de equipamento registrada"}
